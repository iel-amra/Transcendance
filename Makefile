...
migrate: # everytime you add/modify a django model
	- @rm srcs/images/Python/Project/*/migrations/*initial.py
	- @docker exec -it django python manage.py makemigrations
	- @docker exec -it django python manage.py migrate

db: # instantly logs you into the db
	- @docker exec -it db psql -U eavilov -d postgres
...
clog:	# clears the logs of django
	- @truncate -s 0 $$(docker inspect --format='{{.LogPath}}' django)
...
.PHONY: all up upd down lclean clean prune re migrate restart db django clog sus 
